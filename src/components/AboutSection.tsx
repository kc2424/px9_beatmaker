...
export default function AboutSection() {
  ...
  useEffect(() => {
    ...
    if (waveformRef.current && sectionRef.current) {
  ...
  return (
    ...
    >
      {/* Optional Waveform Ambience */}
      <div
        ref={waveformRef}
        className="absolute inset-0 pointer-events-none opacity-20 select-none z-0"
      >
        <Image
          src="/images/06-waveform-optional.png"
          alt="Ambient chiptune waveform light texture in ember rust"
          fill
          sizes="100vw"
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12">
        <div ref={contentRef} className="max-w-3xl">
          ...
          {/* Section Heading */}
          <h2 className="font-brand text-3xl md:text-5xl text-white uppercase tracking-tight mb-8 leading-tight">
            RESTRICTION AS AN ARTISTIC DECISION
          </h2>

          {/* Exact Japanese Copy from contents.md */}
          <div className="space-y-6 font-body text-base md:text-lg text-white/85 leading-relaxed">
            <p>
          ...
          <div className="mt-12 pt-8 border-t border-white/[0.08] grid grid-cols-3 gap-4 max-w-lg">
            <div className="flex flex-col gap-1">
              ...
              <span className="font-brand text-sm md:text-base text-white/90 uppercase tracking-wide">
                SQUARE WAVE
              </span>
            </div>
            <div className="flex flex-col gap-1">
